...
#include "apps/app_prop_tx/app_prop_tx.h"
...
/* Check factory test mode */
    ...
    /* Boot straight into the Prop TX controller (skip the demo launcher / apps) */
    MOONCAKE::USER_APP::PropTx prop_tx;
    prop_tx.setUserData((void*)&hal);
    prop_tx.onSetup();
    prop_tx.onCreate();
    while (1)
    {
