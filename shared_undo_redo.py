...
class CollaborativeUndoRedo:
    ...
    def _transform(self, remote_op: Operation) -> Operation:
        ...
        local_ops = [
            op for op in self.local_manager.get_history()
        ...
        for local_op in local_ops:
            if local_op.widget_id == remote_op.widget_id:
                ...
                if remote_op.type == OperationType.MOVE_WIDGET and local_op.type == OperationType.MOVE_WIDGET:
...
class OperationBuilder:
    ...
    @staticmethod
    def add_widget(widget_id: str, widget_type: str, x: int, y: int,
                  width: int, height: int, **kwargs) -> Operation:
    ...
    @staticmethod
    def move_widget(widget_id: str, old_x: int, old_y: int,
                   new_x: int, new_y: int) -> Operation:
    ...
    @staticmethod
    def resize_widget(widget_id: str, old_width: int, old_height: int,
                     new_width: int, new_height: int) -> Operation:
    ...
    @staticmethod
    def modify_property(widget_id: str, property_name: str,
                       old_value: Any, new_value: Any) -> Operation:
