...
def scene_rc_main():
    ...
    ws.append(
        widget(
            ...
            wid="rc.model_num",
            fg=W1,
            runtime="bind=model_num;kind=str",
        )
    )
    ws.append(
        widget(
    ...
    ws.append(
        widget(
            ...
            wid="rc.batt_v",
            fg=W2,
            runtime="bind=batt_voltage;kind=float;min=3.0;max=4.2",
        )
    )
    ws.append(
        widget(
    ...
    ws.append(
        widget(
            ...
            fg=W1,
            align="right",
            runtime="bind=timer1;kind=str",
        )
    )

    # ── Left stick: THR + RUD (x=0..46) ──
    ws.append(widget("label", 0, 14, text_w(3), LH, "THR", wid="rc.thr_lbl", fg=W1, align="center"))
    ws.append(
        widget("label", 24, 14, text_w(3), LH, "RUD", wid="rc.rud_lbl", fg=W1, align="center")
    )
    ws.append(
        widget(
            "gauge",
    ...
    ws.append(
        widget("label", 208, 14, text_w(3), LH, "AIL", wid="rc.ail_lbl", fg=W1, align="center")
    )
    ws.append(
        widget("label", 232, 14, text_w(3), LH, "ELE", wid="rc.ele_lbl", fg=W1, align="center")
    )
    ws.append(
        widget(
            "gauge",
    ...
    for i, (name, bind) in enumerate(channels):
        ry = 16 + i * 16
        ws.append(widget("label", 50, ry, text_w(3), LH, name, wid=f"rc.{bind}_name", fg=W1))
        ws.append(
            widget(
                "progressbar",
                72,
    ...
    ws.append(
        widget(
            ...
            wid="rc.tx_batt",
            fg=W1,
            runtime="bind=tx_voltage;kind=float;min=3.0;max=5.0",
        )
    )
    ws.append(
        widget(
            ...
            wid="rc.current",
            fg=W1,
            runtime="bind=current;kind=float;min=0;max=50.0",
        )
    )
    ws.append(
        widget(
...
def scene_rc_channels():
    ...
    ch_names = ["Aileron", "Elevator", "Throttle", "Rudder", "Aux 1", "Aux 2", "Aux 3", "Aux 4"]
    for i in range(8):
        col = i // 4
        row = i % 4
        x = col * 128
        ...
        ws.append(
            widget("label", x, y, text_w(7), LH, f"CH{ch} {short}", wid=f"rch.ch{ch}_label", fg=W2)
        )
        ws.append(
            widget(
                "label",
...
def scene_rc_trims():
    ...
    ws.append(
        widget(
            "label", 0, 0, text_w(5), LH, "Trims", wid="rct.title", fg=W2, bold=True, style="bold"
        )
    )
    ...
    for i, (name, bind) in enumerate(trims):
        y = 16 + i * 26
        ws.append(widget("label", 0, y, text_w(3), LH, name[:3], wid=f"rct.{bind}_name", fg=W2))
        ws.append(
            widget(
                "slider",
                text_w(3),
...
def scene_rc_setup():
    ...
    ws.append(
        widget(
            "label", 0, 0, text_w(5), LH, "Setup", wid="rcs.title", fg=W2, bold=True, style="bold"
        )
    )
    ...
    items = [
        ...
        ("TX Power", "rcs.tx_power", "bind=tx_power;kind=list;values=10mW|25mW|50mW|100mW"),
    ...
    for i, name in enumerate(ch_names):
        ...
        ws.append(
            widget(
                ...
                LH,
                "1000",
                wid=f"rcm.ch{ch}_min",
                fg=W1,
                runtime=f"bind=ep{ch}_min;kind=int;min=800;max=1500;step=10",
            )
        )
        ws.append(
            widget(
                ...
                fg=W2,
                runtime=f"bind=ep{ch}_ctr;kind=int;min=1400;max=1600;step=5",
            )
        )
        ws.append(
            widget(
                ...
                fg=W1,
                runtime=f"bind=ep{ch}_max;kind=int;min=1500;max=2200;step=10",
            )
        )
        ws.append(
            widget(
...
def scene_rc_failsafe():
    ...
    ws.append(widget("label", 0, 28, text_w(5), LH, "Mode:", wid="rcf.mode_lbl", fg=W1))
    ws.append(
        widget(
            "button",
            text_w(5),
    ...
    for i in range(4):
        ch = i + 1
        y = 42 + i * 18
        ws.append(widget("label", 0, y, text_w(3), LH, names[i], wid=f"rcf.ch{ch}_name", fg=W2))
        ws.append(
            widget(
                "slider",
                text_w(3),
...
def scene_rc_telemetry():
    ...
    ws.append(
        widget(
            "label", 0, 28, text_w(3), LH, "BAT", wid="rct2.bat_lbl", fg=DM, bold=True, style="bold"
        )
    )
    ws.append(
        widget(
    ...
    for c in range(1, 5):
        xo = (c - 1) * 64
        ws.append(widget("label", xo, 42, text_w(2), LH, f"C{c}", wid=f"rct2.cell{c}_lbl", fg=DM))
        ws.append(
            widget(
                "label",
                xo + 16,
    ...
    ws.append(
        widget(
            ...
            wid="rct2.amp_val",
            fg=W2,
            runtime="bind=current;kind=float;min=0;max=99.9",
        )
    )
    ...
    ws.append(
        widget(
            ...
            wid="rct2.mah_val",
            fg=W2,
            runtime="bind=mah_used;kind=int;min=0;max=99999",
        )
    )
    ws.append(
        widget(
            ...
            wid="rct2.watts",
            fg=W1,
            runtime="bind=watts;kind=float;min=0;max=999",
        )
    )
    ...
    ws.append(
        widget(
            "label", 0, 70, text_w(3), LH, "GPS", wid="rct2.gps_lbl", fg=DM, bold=True, style="bold"
        )
    )
    ws.append(
        widget(
            ...
            wid="rct2.gps_sats",
            fg=W1,
            runtime="bind=gps_sats;kind=int;min=0;max=30",
        )
    )
    ws.append(
        widget(
    ...
    ws.append(
        widget(
            ...
            wid="rct2.spd_val",
            fg=W2,
            runtime="bind=gps_speed;kind=float;min=0;max=999",
        )
    )
    ...
    ws.append(
        widget(
            ...
            wid="rct2.alt_val",
            fg=W2,
            runtime="bind=gps_alt;kind=float;min=-99;max=9999",
        )
    )
    ...
    ws.append(
        widget(
            ...
            wid="rct2.dst_val",
            fg=W2,
            runtime="bind=gps_dist;kind=float;min=0;max=99999",
        )
    )
    ...
    ws.append(
        widget(
            ...
            wid="rct2.hdg_val",
            fg=W1,
            runtime="bind=gps_hdg;kind=int;min=0;max=359",
        )
    )
...
def scene_rc_rates():
    ...
    ws.append(
        widget(
            "label", 0, 0, text_w(5), LH, "RATES", wid="rcr.title", fg=W2, bold=True, style="bold"
        )
    )
    ws.append(
        widget(
            ...
            wid="rcr.prof",
            fg=W1,
            runtime="bind=rate_profile;kind=str",
        )
    )

    # Column headers (y=14)
    ws.append(
        widget("label", 66, 14, text_w(4), LH, "RATE", wid="rcr.hdr_dr", fg=DM, align="center")
    )
    ws.append(
        widget("label", 168, 14, text_w(4), LH, "EXPO", wid="rcr.hdr_ex", fg=DM, align="center")
    )
...
def scene_rc_mixer():
    ...
    ws.append(
        widget(
            "label", 0, 0, text_w(5), LH, "MIXES", wid="rcx.title", fg=W2, bold=True, style="bold"
        )
    )
    ...
    for j, (name, bind, val) in enumerate(mixes):
        ...
        ws.append(widget("label", 0, y, text_w(7), LH, name, wid=f"rcx.{bind}_lbl", fg=W1))
        ws.append(
            widget(
                "progressbar",
                48,
...
def validate_scene(scene_name, scene):
    ...
    for i, w in enumerate(widgets):
        ...
        if wid:
            if wid in seen_ids:
                errors.append(
                    f"DUPLICATE_ID: {ref} — id '{wid}' already used by widget #{seen_ids[wid]}"
                )
            else:
                seen_ids[wid] = i
        else:
        ...
        if wt in TEXT_TYPES and text:
            ...
            if max_lines < 1:
                errors.append(
                    f"TEXT_OVERFLOW_V: {ref} — h={wh}, inner_h={inner_h}, "
                    f"can fit 0 lines (need ≥8px inner)"
                )
            if len(text) > max_chars and max_chars > 0:
                errors.append(
                    f"TEXT_OVERFLOW_H: {ref} — text '{text}' ({len(text)} chars) "
        ...
        if wt in TEXT_TYPES and text:
            ...
            if ww < min_w:
                errors.append(f"TOO_NARROW: {ref} — w={ww} < min {min_w} (can't fit even 1 char)")
        ...
        if bstyle not in VALID_BORDER_STYLES:
            errors.append(
                f"BAD_BORDER_STYLE: {ref} — '{bstyle}' not in {sorted(VALID_BORDER_STYLES)}"
            )
        ...
        if fg_str:
            ...
            if fg_rgb is None:
                ...
                if br < MIN_VISIBLE_BRIGHTNESS:
                    errors.append(
                        f"INVISIBLE_TEXT: {ref} — fg='{fg_str}' brightness "
        ...
        if wt in TEXT_TYPES and text and fg_str and bg_str:
            ...
            if fg_rgb and bg_rgb:
                ...
                if contrast < 40:
                    errors.append(
                        f"LOW_CONTRAST: {ref} — fg='{fg_str}' vs bg='{bg_str}' "
        ...
        if ww < sw:  # widget narrower than scene → check horizontal edges
            if x > 0 and x + ww > sw - MIN_EDGE_MARGIN:
                errors.append(
                    f"EDGE_MARGIN_R: {ref} — right edge {x + ww} "
        ...
        if wh < sh:  # widget shorter than scene → check vertical edges
            if y > 0 and y + wh > sh - MIN_EDGE_MARGIN:
                errors.append(
                    f"EDGE_MARGIN_B: {ref} — bottom edge {y + wh} "
        ...
        if wt in TEXT_TYPES and text:
            ...
            if bad:
                ...
                errors.append(
                    f"UNSUPPORTED_CHAR: {ref} — text '{text}' has chars not in font: {unique!r}"
                )
        ...
        for _i, w in enumerate(scene["widgets"]):
            ...
            if wid:
                if wid in global_ids:
                    all_errors.append(f"GLOBAL_DUP_ID: '{wid}' in {name} and {global_ids[wid]}")
                else:
                    global_ids[wid] = name
