    ...
    def _nav_template(self) -> Template:
        ...
        scene_data = {
            ...
            "widgets": [
                ...
                {"type": "label", "x": 4, "y": 4, "width": 32, "height": 8, "text": "MENU", "border": False},
                {"type": "button", "x": 4, "y": 16, "width": 32, "height": 10, "text": "Home", "border": True},
                {"type": "button", "x": 4, "y": 28, "width": 32, "height": 10, "text": "Stats", "border": True},
                {"type": "button", "x": 4, "y": 40, "width": 32, "height": 10, "text": "Settings", "border": True},
            ],
        }
        return Template(metadata, _make_scene(scene_data))
    ...
    def _data_cards_template(self) -> Template:
        ...
        scene_data = {
            ...
            "widgets": [
                ...
                {"type": "label", "x": 6, "y": 8, "width": 36, "height": 8, "text": "CPU", "border": False},
                {"type": "gauge", "x": 8, "y": 14, "width": 32, "height": 10, "value": 64},
                {"type": "box", "x": 50, "y": 6, "width": 40, "height": 20, "border": True},
                {"type": "label", "x": 52, "y": 8, "width": 36, "height": 8, "text": "NET", "border": False},
                {"type": "progressbar", "x": 52, "y": 16, "width": 32, "height": 8, "value": 45},
                {"type": "box", "x": 96, "y": 6, "width": 40, "height": 20, "border": True},
                {"type": "label", "x": 98, "y": 8, "width": 36, "height": 8, "text": "MEM", "border": False},
                {"type": "chart", "x": 98, "y": 16, "width": 36, "height": 8, "data_points": [5, 10, 6, 12]},
            ],
        }
        return Template(metadata, _make_scene(scene_data))
    ...
    def _status_bar_template(self) -> Template:
        ...
        scene_data = {
            ...
            "widgets": [
                ...
                {"type": "label", "x": 4, "y": 56, "width": 40, "height": 8, "text": "PWR 82%", "border": False},
                {"type": "label", "x": 48, "y": 56, "width": 36, "height": 8, "text": "WIFI OK", "border": False},
                {"type": "label", "x": 90, "y": 56, "width": 34, "height": 8, "text": "12:34", "border": False, "align": "right"},
            ],
        }
        return Template(metadata, _make_scene(scene_data))
    ...
    def _pixel_hud_template(self) -> Template:
        ...
        scene_data = {
            ...
            "widgets": [
                ...
                {"type": "label", "x": 2, "y": 2, "width": 50, "height": 8, "text": "CORE", "border": False},
                {"type": "label", "x": 80, "y": 2, "width": 46, "height": 8, "text": "12:34", "align": "right", "border": False},
                {"type": "progressbar", "x": 2, "y": 18, "width": 124, "height": 6, "value": 60, "border": True, "style": "segmented"},
            ],
        }
        return Template(metadata, _make_scene(scene_data))
