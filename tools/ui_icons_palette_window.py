"""Icon palette window implementation for the Tk designer preview."""
...
except Exception:  # pragma: no cover - Tk not available in headless CI
    tk = None  # type: ignore
...
if tk is not None:
    ...
    class IconPaletteWindow:  # type: ignore[misc]
        def __init__(self, *args, **kwargs):
            raise RuntimeError(
                "Tkinter is not available; IconPaletteWindow requires a GUI environment."
            )
