...
def draw_widget_preview(
    ...
    if kind == "panel":
        _render_panel(app, surface, rect, w, fg, bg, label, padding)
    elif kind == "checkbox":
        _render_checkbox(app, surface, rect, w, fg, label, padding, use_device_font)
    elif kind == "progressbar":
        _render_progressbar(app, surface, rect, w, fg, bg, label, padding)
    elif kind == "button":
        _render_button(app, surface, rect, w, fg, bg, label, padding, pressed)
    elif kind == "textbox":
        _render_textbox(app, surface, rect, w, fg, bg, label, padding, is_selected)
    elif kind == "slider":
        _render_slider(app, surface, rect, w, fg, bg, label, padding)
    elif kind == "gauge":
        ...
        _render_icon(app, surface, rect, w, fg, label, padding, use_device_font)
    elif kind == "radiobutton":
        _render_radiobutton(app, surface, rect, w, fg, label, padding, use_device_font)
    elif kind == "box":
        _render_box(surface, rect, bg)
    else:
        _render_label(app, surface, rect, w, fg, label, padding)
