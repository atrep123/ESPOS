...
TOOLBAR_TOOLTIPS = {
    ...
    "tpl": "Template menu",
    "icons": "Icon palette: browse + apply Material icons (I)",
...
def draw_help_overlay(app) -> None:
    ...
    shortcuts = [
        ...
        "Ctrl+S save | Ctrl+L load | Ctrl+E export C | SVG btn export SVG",
        ...
        "I icon palette (browse+apply) | Shift+I widget info",
        "Template Mgr: type=search Enter=apply Ins=insert R=ren Del S=save",
        "E smart edit | Shift+E edit runtime",
        ...
        "Ctrl+Shift+T Template Manager | Ctrl+Shift+J snap pos+size",
