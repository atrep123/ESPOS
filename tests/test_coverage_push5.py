...
class TestFocusNavEdges:
    ...
    def test_activate_focused_checkbox(self, tmp_path, monkeypatch):
    ...
    def test_activate_focused_slider(self, tmp_path, monkeypatch):
    ...
    def test_activate_focused_button(self, tmp_path, monkeypatch):
    ...
    def test_focus_move_direction_single_focusable(self, tmp_path, monkeypatch):
    ...
    def test_apply_sim_listmodel_missing_slot(self, tmp_path, monkeypatch):
    ...
    def test_sim_try_scroll_count_le_visible(self, tmp_path, monkeypatch):
    ...
    def test_focus_move_direction_gap0_vertical(self, tmp_path, monkeypatch):
    ...
    def test_focus_move_direction_gap0_horizontal(self, tmp_path, monkeypatch):
...
class TestTransformsEdges:
    ...
    def test_move_selection_locked(self, tmp_path, monkeypatch):
    ...
    def test_resize_selection_locked(self, tmp_path, monkeypatch):
    ...
    def test_mirror_selection_bounds_none(self, tmp_path, monkeypatch):
...
class TestLayoutEdges:
    ...
    def test_auto_flow_layout_oob(self, tmp_path, monkeypatch):
    ...
    def test_auto_flow_layout_save_raise(self, tmp_path, monkeypatch):
        """L283-284: auto_flow_layout _save_state exception."""
        from cyberpunk_designer.selection_ops.layout import auto_flow_layout

        app = _make_app(tmp_path, monkeypatch, widgets=[_w(x=0), _w(x=40)])
        app.state.selected = [0, 1]
        _make_save_raise(app)
        auto_flow_layout(app)

    def test_space_evenly_h_oob(self, tmp_path, monkeypatch):
        """L317: filtered < 3."""
    ...
    def test_space_evenly_h_save_raise(self, tmp_path, monkeypatch):
        """L321-322"""
        from cyberpunk_designer.selection_ops.layout import space_evenly_h
    ...
    def test_space_evenly_v_oob(self, tmp_path, monkeypatch):
        """L347"""
    ...
    def test_space_evenly_v_save_raise(self, tmp_path, monkeypatch):
        """L351-352"""
        from cyberpunk_designer.selection_ops.layout import space_evenly_v
    ...
    def test_shrink_to_content_no_children(self, tmp_path, monkeypatch):
        """L375"""
    ...
    def test_distribute_columns_oob_widget(self, tmp_path, monkeypatch):
        """L433"""
        from cyberpunk_designer.selection_ops.layout import distribute_columns
    ...
    def test_distribute_rows_oob_widget(self, tmp_path, monkeypatch):
        """L467"""
        from cyberpunk_designer.selection_ops.layout import distribute_rows

        app = _make_app(tmp_path, monkeypatch, widgets=[_w(y=0), _w(y=40)])
        app.state.selected = [0, 1, 999]
        distribute_rows(app)
...
class TestBatchOpsSaveRaise:
    ...
    def _app1(self, tmp_path, monkeypatch, **kw):
        app = _make_app(tmp_path, monkeypatch, widgets=[_w(**kw)])
        app.state.selected = [0]
        _make_save_raise(app)
        return app

    def _app2(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch, widgets=[_w(x=0), _w(x=40)])
        app.state.selected = [0, 1]
        _make_save_raise(app)
        return app
