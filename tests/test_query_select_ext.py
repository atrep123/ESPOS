...
class TestSelectUnlocked:
    ...
    def test_all_locked(self, make_app):
        app = make_app()
        _add(app, locked=True)
...
class TestSelectDisabled:
    ...
    def test_all_enabled(self, make_app):
        app = make_app()
        _add(app, enabled=True)
...
class TestSearchWidgetsGuards:
    def test_empty_query(self, make_app):
        app = make_app()
        _add(app, text="Hello")
...
class TestSelectHiddenGuards:
    ...
    def test_has_hidden(self, make_app):
        app = make_app()
        _add(app, visible=True)
...
class TestSelectLockedGuards:
    ...
    def test_selects_locked(self, make_app):
        app = make_app()
        _add(app, locked=True)
        _add(app, locked=False)
        select_locked(app)
    ...
    def test_from_locked_selects_unlocked(self, make_app):
        app = make_app()
        _add(app, locked=True)
        _add(app, locked=False)
...
class TestSelectOverlappingGuards:
    ...
    def test_no_overlaps(self, make_app):
        app = make_app()
...
class TestInvertSelectionGuards:
    ...
    def test_all_selected(self, make_app):
        app = make_app()
        _add(app)
        _add(app)
        _sel(app, 0, 1)
...
class TestSelectParentPanelGuards:
    ...
    def test_has_parent(self, make_app):
        app = make_app()
...
class TestSelectChildrenGuards:
    ...
    def test_not_a_panel(self, make_app):
        app = make_app()
        _add(app, type="label")
        _sel(app, 0)
        select_children(app)  # not a panel

    def test_has_children(self, make_app):
        app = make_app()
        _add(app, type="panel", x=0, y=0, width=100, height=100)
        _add(app, type="label", x=10, y=10, width=20, height=10)
    ...
    def test_no_children(self, make_app):
        app = make_app()
...
class TestSelectBorderedGuards:
    ...
    def test_no_bordered(self, make_app):
        app = make_app()
...
class TestSelectAllPanelsGuards:
    ...
    def test_no_panels(self, make_app):
        app = make_app()
        _add(app, type="label")
        select_all_panels(app)

    def test_has_panels(self, make_app):
        app = make_app()
        _add(app, type="label")
        _add(app, type="panel")
        select_all_panels(app)
