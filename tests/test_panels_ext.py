...
class TestDrawPalette:
    ...
    def test_with_selected_widget(self, tmp_path, monkeypatch):
    ...
    def test_hover_over_section_header(self, tmp_path, monkeypatch):
...
class TestDrawInspector:
    ...
    def test_editing_field(self, tmp_path, monkeypatch):
    ...
    def test_layer_drag(self, tmp_path, monkeypatch):
...
class TestDrawStatus:
    ...
    def test_mouse_over_canvas(self, tmp_path, monkeypatch):
    ...
    def test_selected_locked(self, tmp_path, monkeypatch):
    ...
    def test_selected_hidden(self, tmp_path, monkeypatch):
    ...
    def test_selected_disabled(self, tmp_path, monkeypatch):
    ...
    def test_selected_nondefault_style(self, tmp_path, monkeypatch):
    ...
    def test_multi_selected(self, tmp_path, monkeypatch):
    ...
    def test_sim_input_mode(self, tmp_path, monkeypatch):
    ...
    def test_sim_input_mode_editing(self, tmp_path, monkeypatch):
    ...
    def test_undo_redo_counts(self, tmp_path, monkeypatch):
    ...
    def test_dialog_message(self, tmp_path, monkeypatch):
    ...
    def test_dirty_indicator(self, tmp_path, monkeypatch):
