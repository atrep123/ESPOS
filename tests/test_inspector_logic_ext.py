...
class TestInspectorFieldToStr:
    ...
    def test_multi_select_mixed_color(self, make_app):
        app = make_app()
    ...
    def test_multi_select_same_color(self, make_app):
        app = make_app()
        _add(app, color_fg="15")
        _add(app, color_fg="15")
        _sel(app, 0, 1)
...
class TestCommitPosition:
    def test_valid_position(self, make_app):
        app = make_app()
        _add(app, x=0, y=0)
        _sel(app, 0)
    ...
    def test_invalid_position(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
...
class TestCommitPadding:
    ...
    def test_invalid_format(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_negative_rejected(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
...
class TestCommitMargin:
    ...
    def test_invalid(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
...
class TestCommitSpacing:
    ...
    def test_wrong_part_count(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_non_int(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
...
class TestCommitSize:
    ...
    def test_comma_format(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_zero_rejected(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
...
class TestCommitValueRange:
    ...
    def test_min_gt_max_rejected(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
...
class TestCommitGotoWidget:
    def test_valid_index(self, make_app):
        app = make_app()
        _add(app)
        _add(app)
...
class TestCommitSceneName:
    def test_rename_scene(self, make_app):
        app = make_app()
        _start_edit(app, "_scene_name", "new_name")
        assert inspector_commit_edit(app) is True
        assert app.designer.current_scene == "new_name"

    def test_empty_rejected(self, make_app):
        app = make_app()
        _start_edit(app, "_scene_name", "")
        assert inspector_commit_edit(app) is False

    def test_invalid_chars_rejected(self, make_app):
        app = make_app()
        _start_edit(app, "_scene_name", "a/b")
        assert inspector_commit_edit(app) is False

    def test_same_name_noop(self, make_app):
        app = make_app()
        name = app.designer.current_scene
        _start_edit(app, "_scene_name", name)
        assert inspector_commit_edit(app) is True

    def test_duplicate_name_rejected(self, make_app):
        app = make_app()
        app._add_new_scene()
...
class TestCommitArrayDup:
    ...
    def test_wrong_format(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
...
class TestCommitSingleWidget:
    ...
    def test_runtime(self, make_app):
        app = make_app()
        _add(app, runtime="")
        _sel(app, 0)
    ...
    def test_x_invalid(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_min_value(self, make_app):
        app = make_app()
    ...
    def test_max_value(self, make_app):
        app = make_app()
        _add(app, type="gauge", min_value=0, max_value=100)
        _sel(app, 0)
    ...
    def test_z_index(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_color_fg_valid(self, make_app):
        app = make_app()
    ...
    def test_color_fg_invalid(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_color_bg_valid(self, make_app):
        app = make_app()
    ...
    def test_align_valid(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_align_invalid(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_valign_valid(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_valign_invalid(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_border_style_valid(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_border_style_invalid(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_text_overflow_valid(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_text_overflow_invalid(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_max_lines_valid(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_max_lines_zero_sets_none(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_max_lines_invalid(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_data_points_valid(self, make_app):
        app = make_app()
        _add(app, type="chart")
        _sel(app, 0)
    ...
    def test_data_points_invalid(self, make_app):
        app = make_app()
        _add(app, type="chart")
        _sel(app, 0)
    ...
    def test_chart_mode_invalid(self, make_app):
        app = make_app()
        _add(app, type="chart")
        _sel(app, 0)
    ...
    def test_unknown_field(self, make_app):
        app = make_app()
        _add(app)
        _sel(app, 0)
    ...
    def test_no_widget_selected(self, make_app):
        app = make_app()
        _add(app)
        _sel(app)
        _start_edit(app, "text", "new")
    ...
    def test_no_field_returns_true(self, make_app):
        app = make_app()
...
class TestCommitMultiWidget:
    def test_multi_x(self, make_app):
        app = make_app()
    ...
    def test_multi_y(self, make_app):
        app = make_app()
    ...
    def test_multi_width(self, make_app):
        app = make_app()
        _add(app, x=0, y=0, width=20, height=10)
    ...
    def test_multi_color_fg(self, make_app):
        app = make_app()
        _add(app, color_fg="black")
    ...
    def test_multi_align(self, make_app):
        app = make_app()
        _add(app, align="left")
    ...
    def test_multi_valign(self, make_app):
        app = make_app()
        _add(app)
        _add(app)
        _sel(app, 0, 1)
    ...
    def test_multi_border_style(self, make_app):
        app = make_app()
        _add(app)
        _add(app)
        _sel(app, 0, 1)
    ...
    def test_multi_text_overflow(self, make_app):
        app = make_app()
        _add(app)
        _add(app)
        _sel(app, 0, 1)
    ...
    def test_multi_max_lines(self, make_app):
        app = make_app()
        _add(app)
        _add(app)
        _sel(app, 0, 1)
    ...
    def test_multi_max_lines_zero(self, make_app):
        app = make_app()
        _add(app)
        _add(app)
        _sel(app, 0, 1)
    ...
    def test_multi_text(self, make_app):
        app = make_app()
        _add(app, text="a")
        _add(app, text="b")
        _sel(app, 0, 1)
    ...
    def test_multi_runtime(self, make_app):
        app = make_app()
        _add(app)
        _add(app)
        _sel(app, 0, 1)
    ...
    def test_multi_data_points_chart(self, make_app):
        app = make_app()
        _add(app, type="chart")
        _add(app, type="chart")
        _sel(app, 0, 1)
    ...
    def test_multi_chart_mode(self, make_app):
        app = make_app()
        _add(app, type="chart")
        _add(app, type="chart")
        _sel(app, 0, 1)
    ...
    def test_multi_unknown_field(self, make_app):
        app = make_app()
        _add(app)
        _add(app)
        _sel(app, 0, 1)
...
class TestComputeInspectorRows:
    ...
    def test_single_selection(self, make_app):
        app = make_app()
