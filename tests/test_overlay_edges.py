...
class TestContextMenuEdgeCases:
    ...
    def test_clamp_top_left_corner(self, make_app):
    ...
    def test_clamp_bottom_right_corner(self, make_app):
    ...
    def test_many_items_tall_menu(self, make_app):
    ...
    def test_all_separators(self, make_app):
    ...
    def test_mixed_separators_and_actions(self, make_app):
    ...
    def test_not_visible_is_noop(self, make_app):
    ...
    def test_no_logical_surface(self, make_app):
...
class TestTooltipEdgeCases:
    ...
    def test_tooltip_near_right_edge(self, make_app):
    ...
    def test_tooltip_near_bottom_edge(self, make_app):
    ...
    def test_tooltip_different_keys_reset_timer(self, make_app):
    ...
    def test_tab_hover_modified_scene(self, make_app):
...
class TestHelpOverlayEdgeCases:
    ...
    def test_no_layout(self, make_app):
    ...
    def test_zero_dimension_layout(self, make_app):
    ...
    def test_no_state_current_scene(self, make_app):
    ...
    def test_visible_with_widgets(self, make_app):
...
class TestShortcutsPanel:
    ...
    def test_hidden_by_default(self, make_app):
    ...
    def test_zero_layout_noop(self, make_app):
    ...
    def test_toggle_keybind(self, make_app, monkeypatch):
    ...
    def test_esc_dismisses(self, make_app, monkeypatch):
