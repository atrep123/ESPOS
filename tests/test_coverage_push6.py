...
class TestSimModeEditValueExit:
    ...
    def test_backspace_exits_edit_value_in_sim(self, make_app, monkeypatch):
...
class TestUndoRedoSuccess:
    ...
    def test_ctrl_z_undo_succeeds(self, make_app, monkeypatch):
    ...
    def test_ctrl_y_redo_succeeds(self, make_app, monkeypatch):
...
class TestSceneNavigation:
    ...
    def test_ctrl_pagedown_next_scene(self, make_app, monkeypatch):
    ...
    def test_ctrl_pageup_prev_scene(self, make_app, monkeypatch):
...
class TestLetterShiftEditorStart:
    ...
    def test_shift_v_value_range(self, make_app, monkeypatch):
    ...
    def test_shift_t_text_overflow(self, make_app, monkeypatch):
    ...
    def test_shift_b_border_width(self, make_app, monkeypatch):
    ...
    def test_c_color_fg(self, make_app, monkeypatch):
    ...
    def test_shift_c_color_bg(self, make_app, monkeypatch):
    ...
    def test_u_z_index(self, make_app, monkeypatch):
    ...
    def test_shift_u_same_z(self, make_app, monkeypatch):
    ...
    def test_j_margin_edit(self, make_app, monkeypatch):
    ...
    def test_shift_j_clear_margins(self, make_app, monkeypatch):
    ...
    def test_d_data_points(self, make_app, monkeypatch):
    ...
    def test_shift_d_array_duplicate(self, make_app, monkeypatch):
    ...
    def test_f_max_lines(self, make_app, monkeypatch):
    ...
    def test_shift_i_widget_info(self, make_app, monkeypatch):
    ...
    def test_h_size(self, make_app, monkeypatch):
    ...
    def test_shift_h_position(self, make_app, monkeypatch):
    ...
    def test_r_text_edit(self, make_app, monkeypatch):
    ...
    def test_shift_r_auto_rename(self, make_app, monkeypatch):
    ...
    def test_k_padding(self, make_app, monkeypatch):
    ...
    def test_shift_k_all_spacing(self, make_app, monkeypatch):
...
class TestSimArrowEditValue:
    ...
    def test_down_adjusts_value_in_sim_edit(self, make_app, monkeypatch):
...
class TestArrowKeyVariants:
    ...
    def test_up_arrow_moves(self, make_app, monkeypatch):
    ...
    def test_down_arrow_moves(self, make_app, monkeypatch):
    ...
    def test_ctrl_arrow_precise(self, make_app, monkeypatch):
    ...
    def test_shift_arrow_big_step(self, make_app, monkeypatch):
...
class TestInspectorSingleEdit:
    ...
    def test_edit_width(self, make_app):
    ...
    def test_edit_height(self, make_app):
    ...
    def test_edit_value(self, make_app):
    ...
    def test_edit_color_fg(self, make_app):
    ...
    def test_edit_align(self, make_app):
    ...
    def test_edit_align_invalid(self, make_app):
    ...
    def test_edit_valign(self, make_app):
    ...
    def test_edit_border_style(self, make_app):
    ...
    def test_edit_text_overflow(self, make_app):
    ...
    def test_edit_max_lines_none(self, make_app):
    ...
    def test_edit_max_lines_value(self, make_app):
    ...
    def test_edit_text_single(self, make_app):
    ...
    def test_edit_runtime(self, make_app):
    ...
    def test_edit_data_points_chart(self, make_app):
    ...
    def test_edit_chart_mode(self, make_app):
    ...
    def test_edit_unknown_field(self, make_app):
...
class TestInspectorMultiEdit:
    ...
    def test_multi_data_points(self, make_app):
...
class TestInspectorQuickEdits:
    ...
    def test_position_edit(self, make_app):
    ...
    def test_position_invalid(self, make_app):
    ...
    def test_padding_edit(self, make_app):
    ...
    def test_margin_edit(self, make_app):
    ...
    def test_size_edit(self, make_app):
        """L519-520: _size edit."""
        from cyberpunk_designer.inspector_logic import inspector_commit_edit
    ...
    def test_value_range_edit(self, make_app):
    ...
    def test_spacing_edit(self, make_app):
...
class TestComputeInspectorRows:
    ...
    def test_checkbox_rows(self, make_app):
    ...
    def test_multi_select_rows(self, make_app):
...
class TestParsePair:
    ...
    def test_too_many_parts(self, make_app):
    ...
    def test_space_separated(self, make_app):
