...
class TestNudgeLocked:
    def test_nudge_locked_widget(self, make_app):
...
class TestResizeEdges:
    def test_resize_invalid_selection(self, make_app):
    ...
    def test_resize_zero_dim_widget(self, make_app):
...
class TestMakeFullHeightLocked:
    def test_full_height_locked(self, make_app):
...
class TestPruneDegenerateNone:
    def test_no_degenerate_widgets(self, make_app):
...
class TestAssignToParentPanel:
    def test_child_enclosed_by_panel(self, make_app):
...
class TestSelectOverflow:
    def test_select_overflow_with_icon(self, make_app):
    ...
    def test_select_overflow_truncated_text(self, make_app):
...
class TestWrapTextPxEdges:
    def test_whitespace_only_input(self, make_app):
    ...
    def test_text_exceeds_max_lines(self, make_app):
...
class TestDrawTextClippedEdges:
    def test_tiny_clip_rect_max_lines_one(self, make_app):
    ...
    def test_whitespace_only_text_returns_empty_lines(self, make_app):
...
class TestWidgetTextOverflow:
    def test_text_overflow_auto_pixel_font(self, make_app):
    ...
    def test_text_overflow_auto_device_font(self, make_app):
    ...
    def test_text_overflow_wrap_device_font(self, make_app):
...
class TestStatusBarMultiScene:
    def test_status_bar_with_two_scenes(self, make_app):
    ...
    def test_status_bar_mouse_on_canvas(self, make_app, tmp_path, monkeypatch):
...
class TestPaletteWidgetHover:
    def test_palette_widget_row_hover(self, make_app, tmp_path, monkeypatch):
...
class TestInspectorPanelHover:
    def test_section_header_hover(self, make_app, tmp_path, monkeypatch):
    ...
    def test_layer_drag_highlight(self, make_app, tmp_path, monkeypatch):
    ...
    def test_inspector_resources_warning(self, make_app, tmp_path, monkeypatch):
