...
class TestCreatorsPlaceBelowSelection:
    ...
    def test_slider_with_label_below_selection(self, make_app):
    ...
    def test_gauge_panel_below_selection(self, make_app):
    ...
    def test_progress_section_below_selection(self, make_app):
    ...
    def test_icon_button_row_below_selection(self, make_app):
    ...
    def test_card_layout_below_selection(self, make_app):
    ...
    def test_wrap_in_panel_no_bounds(self, make_app):
...
class TestAlignmentEdges:
    ...
    def test_center_in_scene_save_state_exc(self, make_app):
    ...
    def test_center_in_parent_out_of_range(self, make_app):
    ...
    def test_center_in_parent_not_panel(self, make_app):
    ...
    def test_align_h_centers_first_idx_oob(self, make_app):
    ...
    def test_align_h_centers_secondary_oob(self, make_app):
    ...
    def test_align_v_centers_first_idx_oob(self, make_app):
    ...
    def test_align_v_centers_secondary_oob(self, make_app):
        """align_v_centers with secondary idx out of range (line 240)."""
        from cyberpunk_designer.selection_ops.alignment import align_v_centers

        app = make_app(widgets=[_w(), _w(y=50)])
        app.state.selected = [0, 99]
        align_v_centers(app)

    def test_align_left_oob(self, make_app):
    ...
    def test_align_left_secondary_oob(self, make_app):
    ...
    def test_align_top_oob(self, make_app):
    ...
    def test_align_top_secondary_oob(self, make_app):
    ...
    def test_align_right_oob(self, make_app):
    ...
    def test_align_right_secondary_oob(self, make_app):
    ...
    def test_align_bottom_oob(self, make_app):
    ...
    def test_align_bottom_secondary_oob(self, make_app):
...
class TestFocusNavEdges:
    ...
    def test_ensure_focus_from_selected_idx(self, make_app):
    ...
    def test_ensure_focus_from_focusables(self, make_app):
    ...
    def test_ensure_focus_no_focusable(self, make_app):
        """ensure_focus when no focusable widgets (line 363 — set to None)."""
        from cyberpunk_designer.focus_nav import ensure_focus

        # Icon widgets are not focusable
        app = make_app(widgets=[_w(type="icon")])
        app.focus_idx = None
        app.state.selected_idx = None
        ensure_focus(app)

    def test_focus_move_direction_gap_zero_vertical(self, make_app):
    ...
    def test_focus_move_direction_gap_zero_horizontal(self, make_app):
    ...
    def test_adjust_focused_value_bad_attrs(self, make_app):
    ...
    def test_adjust_focused_value_set_raises(self, make_app, monkeypatch):
    ...
    def test_adjust_focused_no_focusable(self, make_app):
    ...
    def test_activate_checkbox_exc(self, make_app, monkeypatch):
    ...
    def test_sim_scroll_false_return(self, make_app):
        """_sim_try_scroll_list returns False for non-list widget (line 264)."""
        from cyberpunk_designer.focus_nav import focus_move_direction

        w = _w(type="button")
        app = make_app(widgets=[w, _w(type="button", x=0, y=50)])
        app.focus_idx = 0
