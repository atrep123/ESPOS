...
_SINGLE_DELEGATES = [
    "_select_all", "_copy_style", "_arrange_in_row", "_arrange_in_column",
    "_cycle_color_preset", "_toggle_border", "_cycle_text_overflow",
    "_cycle_align", "_cycle_valign", "_swap_fg_bg",
    "_select_same_type", "_toggle_checked", "_reset_to_defaults",
    "_select_locked", "_select_overflow", "_make_full_width",
    "_make_full_height", "_swap_dimensions", "_select_same_z",
    "_select_same_style", "_select_hidden", "_widget_info",
    "_invert_selection", "_auto_rename", "_select_same_color",
    "_scene_stats", "_select_parent_panel", "_select_children",
    "_copy_to_next_scene", "_snap_selection_to_grid",
    "_paste_in_place", "_broadcast_to_all_scenes",
    "_select_same_size", "_clear_margins", "_hide_unselected",
    "_select_bordered", "_move_selection_to_origin",
    "_fit_scene_to_content", "_show_all_widgets",
    "_unlock_all_widgets", "_select_overlapping",
    "_toggle_all_borders", "_remove_degenerate_widgets",
    "_enable_all_widgets", "_sort_widgets_by_position",
    "_compact_widgets", "_snap_sizes_to_grid",
    "_select_all_panels", "_list_templates",
    "_extract_to_new_scene", "_clear_padding",
    "_flatten_z_indices",
    "_cycle_gray_fg", "_cycle_gray_bg",
    "_auto_name_scene",
    "_remove_duplicates",
    "_swap_content", "_outline_mode",
    "_flip_horizontal", "_flip_vertical",
    "_replace_text_in_scene", "_select_same_type_as_current",
    "_zoom_to_selection", "_scene_overview",
    "_widget_type_summary", "_toggle_focus_order_overlay",
    "_export_selection_json",
]

# Methods that need 2+ widgets selected
_MULTI_DELEGATES = [
    "_equalize_widths", "_equalize_heights",
]
...
_REMAINING_ACTIONS = [
    ...
    "edit_text", "duplicate", "copy", "cut", "paste",
    "z_forward", "z_backward", "z_front", "z_back",
    "toggle_lock", "toggle_visibility", "cycle_style",
    "cycle_type", "cycle_border", "reorder_up", "reorder_down",
    "paste_style", "smart_edit", "toggle_enabled",
    "mirror", "center_in_scene", "snap_to_grid",
    "swap_positions", "stack_vertical", "stack_horizontal",
    "quick_clone", "dup_below", "dup_right",
    "equalize_gaps", "grid_arrange", "reverse_order",
    "normalize_sizes", "propagate_border", "increment_text",
    "propagate_style", "clone_text", "propagate_align",
    "propagate_colors", "propagate_value", "propagate_padding",
    "propagate_margin", "propagate_appearance",
    "flow_layout", "measure", "space_h", "space_v",
    "create_header_bar", "create_nav_row", "create_form_pair",
    "create_status_bar", "create_toggle_group", "create_slider_label",
    "create_gauge_panel", "create_progress_section", "create_icon_btn_row",
    "create_card_layout", "create_dashboard_grid", "create_split_layout",
    "wrap_in_panel", "fill_scene", "shrink_to_content",
    "select_children", "select_overlapping",
    "auto_label", "inset_widgets", "outset_widgets",
    "distribute_columns",
    "align_scene_top", "align_scene_bottom",
    "align_scene_left", "align_scene_right",
    "center_h", "center_v", "tile_fill",
    "delete_hidden", "delete_offscreen", "swap_dims",
    "scatter_random", "toggle_checked", "reset_values",
    "flatten_z", "number_ids", "z_by_position",
    "clone_grid", "mirror_scene_h", "sort_by_z",
    "clamp_to_scene", "mirror_scene_v",
    "select_unlocked", "select_disabled", "snap_all_grid",
    "center_in_parent", "size_to_text", "fill_parent",
    "clear_all_text", "move_to_origin", "make_square",
    "scale_up", "scale_down", "number_text",
    "reset_padding", "reset_colors", "outline_only",
    "select_largest", "select_smallest",
    ...
    "distribute_3col", "cascade_arrange", "spread_values",
    "pack_left", "pack_top", "distribute_rows",
    "propagate_text", "match_first_width", "match_first_height",
    "view_grid", "view_rulers", "view_guides",
    "view_snap", "view_ids", "view_zlabels",
    "add_label", "add_button", "add_box",
]
...
_MORE_DELEGATES = [
    "_paste_style", "_cycle_widget_type", "_cycle_border_style",
    "_smart_edit", "_toggle_enabled", "_search_widgets_prompt",
    "_array_duplicate_prompt", "_reorder_selection",
    "_duplicate_selection", "_cut_selection", "_copy_selection",
    "_paste_clipboard", "_toggle_visibility", "_cycle_style",
    "_create_header_bar", "_create_nav_row", "_create_form_pair",
    "_create_status_bar", "_create_toggle_group",
    "_create_slider_with_label", "_create_gauge_panel",
    "_create_progress_section", "_create_icon_button_row",
    "_create_card_layout", "_create_dashboard_grid",
    "_create_split_layout", "_wrap_in_panel", "_fill_scene",
    "_shrink_to_content", "_auto_label_widgets",
    "_distribute_columns", "_inset_widgets", "_outset_widgets",
    "_align_to_scene_top", "_align_to_scene_bottom",
    "_align_to_scene_left", "_align_to_scene_right",
    "_center_horizontal", "_center_vertical",
    "_delete_hidden_widgets", "_delete_offscreen_widgets",
    "_tile_fill_scene", "_match_first_width", "_match_first_height",
    "_scatter_random", "_toggle_all_checked", "_reset_all_values",
    "_propagate_text", "_flatten_z_index", "_number_widget_ids",
    "_z_by_position", "_clone_to_grid", "_distribute_rows",
    "_mirror_scene_horizontal", "_sort_widgets_by_z",
    "_clamp_to_scene", "_mirror_scene_vertical",
    "_select_unlocked", "_snap_all_to_grid", "_select_disabled",
    "_center_in_parent", "_size_to_text", "_pack_left", "_pack_top",
    "_fill_parent", "_clear_all_text", "_move_to_origin",
    "_make_square", "_scale_up", "_scale_down", "_number_text",
    "_spread_values", "_reset_padding", "_reset_colors",
    "_outline_only", "_select_largest", "_select_smallest",
    "_cascade_arrange", "_set_inverse_style", "_set_bold_style",
    "_set_default_style", "_align_h_centers", "_align_v_centers",
    "_align_left_edges", "_align_top_edges",
    "_align_right_edges", "_align_bottom_edges",
    "_distribute_columns_3", "_propagate_border",
    "_increment_text", "_propagate_style", "_clone_text",
    "_propagate_align", "_propagate_colors", "_propagate_value",
    "_propagate_padding", "_propagate_margin",
    "_propagate_appearance", "_auto_flow_layout",
    "_measure_selection", "_space_evenly_h", "_space_evenly_v",
    "_normalize_sizes", "_grid_arrange", "_reverse_widget_order",
    "_quick_clone", "_stack_vertical", "_stack_horizontal",
    "_swap_positions", "_center_in_scene", "_duplicate_below",
    "_duplicate_right",
]
