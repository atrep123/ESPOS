...
class TestSelectionHighlight:
    ...
    def test_no_selection_no_highlight(self, tmp_path, monkeypatch):
    ...
    def test_single_selection_has_border(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
    ...
    def test_multi_selection_bounding_box(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
...
class TestWidgetIdOverlay:
    ...
    def test_ids_visible_when_flag_set(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
    ...
    def test_ids_hidden_when_flag_off(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
        _add_widget(app, "label", x=8, y=8, width=40, height=20, _widget_id="lbl_title")
...
class TestZLabelOverlay:
    ...
    def test_z_labels_appear(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
    ...
    def test_z_labels_hidden_by_default(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
        _add_widget(app, "label", x=8, y=8, width=40, height=20, z_index=5)
        app.show_widget_ids = False
        app.show_z_labels = False
...
class TestFocusOrderOverlay:
    ...
    def test_focus_order_on_focusable(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
        _add_widget(app, "button", x=8, y=8, width=40, height=20)
    ...
    def test_focus_order_skips_label(self, tmp_path, monkeypatch):
    ...
    def test_focus_order_hidden_when_off(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
        _add_widget(app, "button", x=8, y=8, width=40, height=20)
    ...
    def test_focus_order_invisible_widget_skipped(self, tmp_path, monkeypatch):
    ...
    def test_focus_order_disabled_widget_skipped(self, tmp_path, monkeypatch):
...
class TestFocusRing:
    ...
    def test_focus_ring_yellow_normal(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
        idx = _add_widget(app, "button", x=8, y=8, width=40, height=20)
    ...
    def test_no_focus_ring_when_not_sim(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
        idx = _add_widget(app, "button", x=8, y=8, width=40, height=20)
...
class TestCleanPreview:
    ...
    def test_no_selection_overlay_in_clean_preview(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
        idx = _add_widget(app, "button", x=8, y=8, width=40, height=20)
        app.state.selected = [idx]
        app.state.selected_idx = idx
    ...
    def test_no_ids_in_clean_preview(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
    ...
    def test_no_focus_order_in_clean_preview(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
        _add_widget(app, "button", x=8, y=8, width=40, height=20)
        app.show_focus_order = True
        app.clean_preview = True
    ...
    def test_no_focus_ring_in_clean_preview(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
        idx = _add_widget(app, "button", x=8, y=8, width=40, height=20)
        app.sim_input_mode = True
        app.focus_idx = idx
...
class TestBoxSelectRubberBand:
    ...
    def test_box_select_fills_region(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
...
class TestOverlayCoexistence:
    ...
    def test_ids_and_focus_order_together(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
    ...
    def test_selection_and_ids_together(self, tmp_path, monkeypatch):
        app = _make_app(tmp_path, monkeypatch)
