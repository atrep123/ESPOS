...
class TestClipboardExceptions:
    ...
    def test_copy_selection_asdict_exception(self, make_app, monkeypatch):
    ...
    def test_paste_clipboard_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_paste_clipboard_becomes_empty_after_save(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_paste_clipboard_pointer_calc_exception(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_paste_clipboard_asdict_exception_in_loop(self, make_app, monkeypatch):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_cut_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_duplicate_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_duplicate_asdict_exception(self, make_app, monkeypatch):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_copy_to_next_scene_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_copy_to_next_scene_single_scene(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_copy_to_next_scene_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_copy_to_next_scene_oob_index(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_copy_to_next_scene_target_none(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_paste_in_place_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_paste_in_place_asdict_exception(self, make_app, monkeypatch):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_broadcast_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_broadcast_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_broadcast_single_scene(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_quick_clone_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_quick_clone_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_quick_clone_oob_index(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_extract_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_extract_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_extract_oob_no_valid(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_duplicate_below_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_duplicate_below_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_duplicate_below_oob(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_duplicate_right_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_duplicate_right_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_duplicate_right_oob(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_export_selection_json_scrap_exception(self, make_app, monkeypatch):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_export_selection_json_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_export_selection_json_oob(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
...
class TestTransformsExceptions:
    ...
    def test_move_locked_widget(self, make_app):
    ...
    def test_move_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_move_oob_index(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_move_zero_delta(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_resize_locked(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_resize_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_resize_oob_index(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_mirror_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_mirror_oob_index(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_mirror_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_swap_fg_bg_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_swap_fg_bg_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_make_full_width_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_make_full_width_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_make_full_width_oob(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_make_full_height_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_make_full_height_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_swap_dimensions_locked(self, make_app):
        from cyberpunk_designer.selection_ops import transforms

        app = make_app(widgets=[_w(width=60, height=20)])
        app.state.current_scene().widgets[0].locked = True
        app.state.selected = [0]
        transforms.swap_dimensions(app)

    # ---- swap_dimensions: _save_state exception (lines 250-251) ----
    def test_swap_dimensions_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_swap_dimensions_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_swap_dimensions_oob(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_move_to_origin_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import transforms

        app = make_app(widgets=[_w(x=40, y=30)])
        app.state.selected = [0]
        _make_save_raise(app)
    ...
    def test_move_to_origin_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_move_to_origin_oob(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_swap_positions_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import transforms

        app = make_app(widgets=[_w(x=10, y=20), _w(x=50, y=60)])
    ...
    def test_swap_positions_not_two(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_swap_positions_oob(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_flip_vertical_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_flip_vertical_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_flip_vertical_oob(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_swap_content_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import transforms

        app = make_app(widgets=[_w(text="A"), _w(text="B")])
        app.state.selected = [0, 1]
        _make_save_raise(app)
    ...
    def test_swap_content_not_two(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    # ---- swap_content: OOB ----
    def test_swap_content_oob(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_flip_horizontal_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_flip_horizontal_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_flip_horizontal_oob(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_mirror_scene_horizontal_empty(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_mirror_scene_horizontal_normal(self, make_app):
        from cyberpunk_designer.selection_ops import transforms

        app = make_app(widgets=[_w(x=10, y=10, width=30)])
        transforms.mirror_scene_horizontal(app)

    # ---- mirror_scene_vertical: no widgets ----
    def test_mirror_scene_vertical_empty(self, make_app):
        from cyberpunk_designer.selection_ops import transforms
    ...
    def test_mirror_scene_vertical_normal(self, make_app):
        from cyberpunk_designer.selection_ops import transforms

        app = make_app(widgets=[_w(x=10, y=10, height=20)])
        transforms.mirror_scene_vertical(app)

    # ---- move_selection with snap enabled ----
    def test_move_with_snap(self, make_app):
        from cyberpunk_designer.selection_ops import transforms

        app = make_app(widgets=[_w(x=8, y=8)], snap=True)
        app.state.selected = [0]
...
class TestPropagationExceptions:
    ...
    def test_paste_style_save_state_exception(self, make_app):
    ...
    def test_paste_style_no_clipboard(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_paste_style_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_copy_style_nothing_selected(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_border_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_border_single(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_border_first_oob(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_style_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_style_single(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_style_first_oob(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_clone_text_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import propagation

        app = make_app(widgets=[_w(text="src"), _w(text="dst")])
        app.state.selected = [0, 1]
        _make_save_raise(app)
    ...
    def test_clone_text_single(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_clone_text_first_oob(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_align_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_align_single(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_align_first_oob(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_colors_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_colors_single(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_colors_first_oob(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_value_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_value_single(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_value_first_oob(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_border_with_border_width(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_padding_first_oob(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_padding_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_padding_single(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_margin_first_oob(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_margin_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_margin_single(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_appearance_first_oob(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_appearance_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_appearance_single(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_text_first_oob(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_text_single(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
    ...
    def test_propagate_text_normal(self, make_app):
        from cyberpunk_designer.selection_ops import propagation
...
class TestClipboardExtraEdges:
    ...
    def test_copy_to_next_scene_current_not_in_names(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
    ...
    def test_broadcast_target_scene_none(self, make_app):
        from cyberpunk_designer.selection_ops import clipboard
...
class TestLayoutSelectOpsEdges:
    ...
    def test_layout_2plus_single_selected(self, make_app, func_name):
    ...
    @pytest.mark.parametrize("func_name", _LAYOUT_2PLUS)
    def test_layout_2plus_save_state_exception(self, make_app, func_name):
        from cyberpunk_designer.selection_ops import layout as layout_mod

        app = make_app(widgets=[_w(x=0, y=0), _w(x=40, y=0)])
        app.state.selected = [0, 1]
        _make_save_raise(app)
        getattr(layout_mod, func_name)(app)

    @pytest.mark.parametrize("func_name", _LAYOUT_2PLUS)
    def test_layout_2plus_oob_indices(self, make_app, func_name):
        from cyberpunk_designer.selection_ops import layout as layout_mod
    ...
    def test_compact_widgets_empty(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod

        app = make_app()
        layout_mod.compact_widgets(app)

    def test_compact_widgets_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod
    ...
    def test_equalize_gaps_single(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod
    ...
    def test_equalize_gaps_oob(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod
    ...
    def test_equalize_gaps_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod
    ...
    def test_auto_flow_layout_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod
    ...
    def test_auto_flow_layout_empty(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod

        app = make_app()
        layout_mod.auto_flow_layout(app)

    def test_shrink_to_content_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod

        app = make_app(widgets=[_w(text="test")])
        app.state.selected = [0]
        _make_save_raise(app)
        layout_mod.shrink_to_content(app)

    def test_shrink_to_content_empty(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod
    ...
    def test_shrink_to_content_continue_branch(self, make_app):
        """Widget with no text and no icon -> skip (continue branch)."""
        from cyberpunk_designer.selection_ops import layout as layout_mod

        app = make_app(widgets=[_w(text="")])
        app.state.current_scene().widgets[0].icon_char = ""
        app.state.selected = [0]
        layout_mod.shrink_to_content(app)

    def test_distribute_columns_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod
    ...
    def test_distribute_columns_empty(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod
    ...
    def test_distribute_rows_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod
    ...
    def test_distribute_rows_empty(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod
    ...
    def test_cascade_arrange_save_state_exception(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod
    ...
    def test_distribute_columns_3(self, make_app):
        from cyberpunk_designer.selection_ops import layout as layout_mod

        app = make_app(widgets=[_w(), _w(), _w()])
...
class TestBatchOpsEdges:
    ...
    def test_batch_save_state_exception(self, make_app, func_name):
        from cyberpunk_designer import selection_ops as batch_ops

        app = make_app(widgets=[_w(x=10, y=10, text="hello")])
        app.state.selected = [0]
        _make_save_raise(app)
        getattr(batch_ops, func_name)(app)

    def test_reorder_nothing_selected(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_reorder_single_widget(self, make_app):
        """n < 2 → return."""
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_reorder_save_state_exception(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_reorder_boundary_first_up(self, make_app):
    ...
    def test_reorder_boundary_last_down(self, make_app):
    ...
    def test_reset_to_defaults_nothing_selected(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_widget_info_nothing(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_array_duplicate_nothing_selected(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_array_duplicate_save_state_exception(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_array_duplicate_oob(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_array_duplicate_asdict_exception(self, make_app, monkeypatch):
    ...
    def test_auto_rename_oob(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_scene_stats_with_disabled(self, make_app):
    ...
    def test_clear_margins_oob(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_remove_degenerate_save_state_exception(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_remove_degenerate_nothing_removed(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops

        app = make_app(widgets=[_w(width=60, height=20)])
        batch_ops.remove_degenerate_widgets(app)

    def test_enable_all_save_state_exception(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_enable_all_already_enabled(self, make_app):
    ...
    def test_sort_widgets_save_state_exception(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_sort_widgets_empty(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops

        app = make_app()
        batch_ops.sort_widgets_by_position(app)

    def test_snap_sizes_save_state_exception(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_snap_sizes_empty(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops

        app = make_app()
        batch_ops.snap_sizes_to_grid(app)

    def test_snap_sizes_no_change(self, make_app):
        """Widget already grid-aligned → 0 changed."""
        from cyberpunk_designer import selection_ops as batch_ops

        app = make_app(widgets=[_w(x=8, y=8, width=24, height=16)])
        batch_ops.snap_sizes_to_grid(app)

    def test_clear_padding_oob(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_flatten_z_save_state_exception(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_flatten_z_empty(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
...
class TestPropertyCyclesEdges:
    ...
    def test_save_except(self, func_name, attr, make_app):
    ...
    @pytest.mark.parametrize(("func_name", "attr"), _CYCLE_SAVE_OOB)
    def test_oob_default(self, func_name, attr, make_app):
        from cyberpunk_designer.selection_ops import property_cycles as pc
    ...
    def test_save_only_except(self, func_name, make_app):
        from cyberpunk_designer.selection_ops import property_cycles as pc
    ...
    def test_undo_oob_continue(self, func_name, make_app):
        from cyberpunk_designer.selection_ops import property_cycles as pc
    ...
    def test_smart_edit_oob(self, make_app):
        from cyberpunk_designer.selection_ops import property_cycles as pc
    ...
    def test_smart_edit_checkbox_save_except(self, make_app):
        from cyberpunk_designer.selection_ops import property_cycles as pc

        app = make_app(widgets=[_w(type="checkbox", checked=False)])
        app.state.selected = [0]
        _make_save_raise(app)
        pc.smart_edit(app)

    # ---- adjust_value OOB continue ----
    def test_adjust_value_oob(self, make_app):
        from cyberpunk_designer.selection_ops import property_cycles as pc
    ...
    def test_toggle_enabled_oob(self, make_app):
        from cyberpunk_designer.selection_ops import property_cycles as pc
    ...
    def test_toggle_checked_oob(self, make_app):
        from cyberpunk_designer.selection_ops import property_cycles as pc
    ...
    def test_toggle_checked_save_except(self, make_app):
        from cyberpunk_designer.selection_ops import property_cycles as pc
    ...
    def test_cycle_gray_fg_oob(self, make_app):
        from cyberpunk_designer.selection_ops import property_cycles as pc
    ...
    def test_cycle_gray_bg_oob(self, make_app):
        from cyberpunk_designer.selection_ops import property_cycles as pc
    ...
    def test_outline_mode_oob(self, make_app):
        from cyberpunk_designer.selection_ops import property_cycles as pc
    ...
    def test_cycle_color_preset_oob(self, make_app):
        from cyberpunk_designer.selection_ops import property_cycles as pc
    ...
    def test_reverse_save_state_exception(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_reverse_empty(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops

        app = make_app()
        batch_ops.reverse_widget_order(app)

    def test_reverse_single(self, make_app):
    ...
    def test_normalize_sizes_save_state_exception(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_auto_name_scene_save_state_exception(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_remove_duplicates_save_state_exception(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops

        app = make_app(widgets=[_w(x=0, y=0), _w(x=0, y=0)])
        _make_save_raise(app)
        batch_ops.remove_duplicates(app)

    def test_remove_duplicates_empty(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops

        app = make_app()
        batch_ops.remove_duplicates(app)

    def test_increment_text_save_state_exception(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops

        app = make_app(widgets=[_w(text="Item 1")])
        app.state.selected = [0]
        _make_save_raise(app)
        batch_ops.increment_text(app)

    def test_increment_text_nothing_selected(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_measure_selection_nothing(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_replace_text_save_state_exception(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_zoom_to_selection_save_state(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
    ...
    def test_zoom_to_selection_nothing(self, make_app):
        from cyberpunk_designer import selection_ops as batch_ops
...
class TestQuerySelectEdges:
    ...
    def test_oob_return(self, func_name, make_app):
    ...
    def test_overlapping_oob(self, make_app):
        from cyberpunk_designer.selection_ops import query_select as qs
    ...
    def test_locked_no_locked(self, make_app):
        from cyberpunk_designer.selection_ops import query_select as qs

        app = make_app(widgets=[_w(locked=False)])
        app.state.selected = []
        qs.select_locked(app)

    # select_overflow: empty scene
    def test_overflow_empty_scene(self, make_app):
        from cyberpunk_designer.selection_ops import query_select as qs
    ...
    def test_overflow_no_overflow(self, make_app):
        from cyberpunk_designer.selection_ops import query_select as qs

        app = make_app(widgets=[_w(text="Hi", width=200, height=100)])
        qs.select_overflow(app)

    # select_overflow: import exception for text_metrics
    def test_overflow_import_fail(self, make_app, monkeypatch):
        from cyberpunk_designer.selection_ops import query_select as qs
    ...
    def test_parent_panel_no_panels(self, make_app):
        from cyberpunk_designer.selection_ops import query_select as qs

        # Scene has only labels, no panels → all iterations hit "continue"
        app = make_app(widgets=[_w(x=10, y=10), _w(x=20, y=20)])
        app.state.selected = [0]
