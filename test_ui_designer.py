...
from ui_designer import BorderStyle, UIDesigner, WidgetConfig, WidgetType
...
def test_ui_designer():
    ...
    for style in [BorderStyle.SINGLE, BorderStyle.DOUBLE, BorderStyle.ROUNDED, BorderStyle.BOLD]:
        widget = WidgetConfig(
            type=WidgetType.BOX.value, x=10, y=32, width=10, height=3, border_style=style.value
        )
        designer.add_widget(widget)
